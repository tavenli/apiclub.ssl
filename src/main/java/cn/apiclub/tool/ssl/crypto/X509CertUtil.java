...
public final class X509CertUtil
{
	    ...
	    throws CryptoException
	{
		...
		{
			throw new CryptoException(MessageFormat.format("CertificateException : {0}", errkey), ex);
		}
	}
	    ...
	    throws CryptoException
	{
		...
		{
			throw new CryptoException("Could not extract trusted certificates from Keystore.", ex);
		}
	}
