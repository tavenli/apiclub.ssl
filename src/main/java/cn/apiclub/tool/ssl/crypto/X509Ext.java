...
import cn.apiclub.tool.ssl.MsgResource;
...
public class X509Ext
{
	    ...
	    throws IOException
	{
		...
		for (int type : KEY_USAGES)
		{
			if ((val & type) == type)
			{
				...
				strBuff.append(MsgResource.Res.getString("KeyUsage." + type));
			}
		}
		return strBuff.toString();
	}
	    ...
	    throws IOException, ParseException
	{
		...
		{
			strBuff.append(MessageFormat.format(MsgResource.Res.getString("PrivateKeyUsagePeriodNotBefore"),
		...
		if ((dTime = pkup.getNotAfter()) != null)
		{
			...
			strBuff.append(MessageFormat.format(MsgResource.Res.getString("PrivateKeyUsagePeriodNotAfter"),
			    formatGeneralizedTime(dTime)));
		}
	    ...
	    throws IOException
	{
		...
		strBuff.append(MsgResource.Res.getString(bc.isCA() ? "SubjectIsCa" : "SubjectIsNotCa"));
		strBuff.append("<br><br>");

		BigInteger pathLen = bc.getPathLenConstraint();
		if (pathLen != null)
		{
			strBuff.append(MessageFormat.format(MsgResource.Res.getString("PathLengthConstraint"), pathLen));
		}
	    ...
	    throws IOException
	{
		...
		for (int i = 0, len = policyMappings.size(); i < len; i++)
		{
			...
			strBuff.append("<li>");
			strBuff.append(MessageFormat.format(MsgResource.Res.getString("PolicyMapping"), i + 1));
			...
			if (pmLen > 0)
			{
				...
				strBuff.append(MessageFormat.format(MsgResource.Res.getString("IssuerDomainPolicy"),
			...
			if (pmLen > 1)
			{
				...
				strBuff.append("<ul><li>");
				strBuff.append(MessageFormat.format(MsgResource.Res.getString("SubjectDomainPolicy"),
	    ...
	    throws IOException
	{
		...
		{
			strBuff.append(MsgResource.Res.getString("KeyIdentifier"));
			strBuff.append(": ");
		...
		if ((authorityCertIssuer = aki.getAuthorityCertIssuer()) != null)
		{
			...
			strBuff.append("<ul><li>");
			strBuff.append(MsgResource.Res.getString("CertificateIssuer"));
			strBuff.append(": ");
		...
		if ((serialNo = aki.getAuthorityCertSerialNumber()) != null)
		{
			...
			strBuff.append(MessageFormat.format(MsgResource.Res.getString("CertificateSerialNumber"), serialNo));
		}
		...
		for (int i = 0, len = policyConstraints.size(); i < len; i++)
		{
			...
			switch (policyConstraint.getTagNo())
			{
				case 0: // Require Explicit Policy Skip Certs
					...
					strBuff.append(MessageFormat.format(MsgResource.Res.getString("RequireExplicitPolicy"), iSkipCerts));
					break;
				case 1: // Inhibit Policy Mapping Skip Certs
					...
					strBuff.append(MessageFormat.format(MsgResource.Res.getString("InhibitPolicyMapping"), iSkipCerts));
					break;
			}
		}
	    ...
	    throws IOException
	{
		...
		return MessageFormat.format(MsgResource.Res.getString("InhibitAnyPolicy"), iSkipCerts);
	}
	    ...
	    throws IOException
	{
		...
		sb.append(MsgResource.Res.getString("MsftCertTemplateId"));
		sb.append(": ");
		sb.append(((DERObjectIdentifier) seq.getObjectAt(0)).getId());
		sb.append("<br><br>");

		DERInteger derInt = (DERInteger) seq.getObjectAt(1);
		sb.append(MessageFormat.format(MsgResource.Res.getString("MsftCertTemplateMajorVer"), derInt.getValue()));

		if ((derInt = (DERInteger) seq.getObjectAt(2)) != null)
		{
			sb.append("<br><br>");
			sb.append(MessageFormat.format(MsgResource.Res.getString("MsftCertTemplateMinorVer"), derInt.getValue()));
		}
	    ...
	    throws IOException
	{
		...
		StringBuilder sb = new StringBuilder();
		sb.append(MessageFormat.format(MsgResource.Res.getString("MsftCaVersionCert"), certIx));
		sb.append("<br><br>");
		sb.append(MessageFormat.format(MsgResource.Res.getString("MsftCaVersionKey"), keyIx));
		return sb.toString();
	}
	    ...
	    throws IOException
	{
		...
		String sParams = MsgResource.Res.getString("SmimeParameters");
	    ...
	    throws IOException
	{
		...
		for (int i = 0, len = logos.size(); i < len; i++)
		{
			...
			{
				case 0:
					sb.append(MsgResource.Res.getString("CommunityLogos"));
					// TODO
					sb.append("<br>");
				...
				case 1:
					sb.append("<ul><li>");
					sb.append(MsgResource.Res.getString("IssuerLogo"));
					...
					break;
				case 2:
					sb.append(MsgResource.Res.getString("SubjectLogo"));
					// TODO
					sb.append("<br>");
					sb.append(stringify(derTag.getObject()));
					break;
				case 3:
					sb.append(MsgResource.Res.getString("OtherLogos"));
					// TODO
					sb.append("<br>");
					sb.append(stringify(derTag.getObject()));
					break;
	    ...
	    throws IOException
	{
		...
		sb.append("<li>").append(MsgResource.Res.getString("NovellKeyQuality"));
		...
		sb.append("<li>").append(MsgResource.Res.getString("NovellCryptoProcessQuality"));
		...
		sb.append("<li>").append(MsgResource.Res.getString("NovellCertClass"));
		sb.append(": ");
		...
		sb.append("<li>");
		sb.append(MsgResource.Res.getString("NovellCertClassValid." + valid));
		sb.append("</li></ul>");
		 ...
		 */
		sb.append(MsgResource.Res.getString("NovellEnterpriseID"));
		sb.append(' ').append(MsgResource.Res.getString("DecodeNotImplemented")); // TODO
	...
	private CharSequence getNovellQualityAttr(ASN1Sequence seq)
	{
		...
		res.append("<li>").append(MsgResource.Res.getString("NovellQualityEnforce"));
		...
		{
			res.append("<li>");
			res.append(MsgResource.Res.getString("NovellCompusecQuality"));
			res.append("<ul>");
			...
			for (int i = 0; i < clen; i++)
			{
				...
				{
					csecRating = MsgResource.Res.getString("UnrecognisedNovellQualityRating");
				}
				csecRating = MessageFormat.format(csecRating, tmp.getValue());
				res.append("<ul><li>").append(MsgResource.Res.getString("NovellQualityRating"));
		...
		res.append("<li>").append(MsgResource.Res.getString("NovellCryptoQuality"));
		res.append(' ').append(MsgResource.Res.getString("DecodeNotImplemented")); // TODO
		res.append("</li>");
		/*
		...
		res.append("<li>").append(MsgResource.Res.getString("NovellKeyStorageQuality"));
	    ...
	    throws IOException
	{
		...
		for (int type : NETSCAPE_CERT_TYPES)
		{
			if ((val & type) == type)
			{
				...
				strBuff.append(MsgResource.Res.getString("NetscapeCertificateType." + type));
			}
		}
		return strBuff.toString();
	}
	    ...
	    throws IOException
	{
		...
		for (DistributionPoint point : points)
		{
			...
			if ((dpn = point.getDistributionPoint()) != null)
			{
				...
				switch (dpn.getType())
				{
					case DistributionPointName.FULL_NAME:
						sb.append(MsgResource.Res.getString("CrlDistributionPoint.0.0"));
						sb.append(": ");
					...
					case DistributionPointName.NAME_RELATIVE_TO_CRL_ISSUER:
						sb.append(MsgResource.Res.getString("CrlDistributionPoint.0.1"));
						sb.append(": ");
						// TODO: need better decode?
						sb.append(stringify(dpn.getName()));
						break;
					default:
						sb.append(MsgResource.Res.getString("UnknownCrlDistributionPointName"));
						sb.append(": ");
						sb.append(stringify(dpn.getName()));
						break;
				}
			...
			{
				sb.append("<li>");
				sb.append(MsgResource.Res.getString("CrlDistributionPoint.1"));
				sb.append(": ");
				// TODO: decode
			...
			{
				sb.append("<li>");
				sb.append(MsgResource.Res.getString("CrlDistributionPoint.2"));
				sb.append(": ");
	    ...
	    throws IOException
	{
		...
		for (int i = 0, len = pSeq.size(); i < len; i++)
		{
			...
			sb.append("<ul><li>");
			sb.append(MsgResource.Res.getString("PolicyIdentifier"));
			sb.append(": ");
			...
			if ((pQuals = pi.getPolicyQualifiers()) != null)
			{
				...
				for (int j = 0, plen = pQuals.size(); j < plen; j++)
				{
					...
					if (pqId.equals(PolicyQualifierId.id_qt_cps))
					{
						...
						sb.append("<li>");
						sb.append(MsgResource.Res.getString("CpsUri"));
						sb.append(": ");
						sb.append(getLink(sUri, escapeHtml(sUri), LinkClass.BROWSER));
						sb.append("</li>");
					}
					else if (pqId.equals(PolicyQualifierId.id_qt_unotice))
					{
						...
						for (int k = 0, dlen = un.size(); k < dlen; k++)
						{
							...
							if (de instanceof DERString)
							{
								// explicitText
								sb.append("<li>");
								sb.append(MsgResource.Res.getString("ExplicitText"));
								sb.append(": ");
							...
							else if (de instanceof ASN1Sequence)
							{
								...
								sb.append("<li>");
								sb.append(MsgResource.Res.getString("NoticeRef"));
								sb.append(": ");
								sb.append(MsgResource.Res.getString("NoticeRefOrganization"));
								sb.append(": ");
								sb.append(orgstr);
								sb.append(", ");
								sb.append(MsgResource.Res.getString("NoticeRefNumber"));
								sb.append(": ");
								sb.append(nrstr);
								sb.append("</li>");
							}
	    ...
	    throws IOException
	{
		...
		switch (tagNo)
		{
			case GeneralName.otherName:
				...
				try
				{
					strBuff.append(MsgResource.Res.getString(sOid));
				}
				catch (MissingResourceException e)
				{
					strBuff.append(MessageFormat.format(MsgResource.Res.getString("GeneralName." + tagNo), sOid));
				}
				strBuff.append(": ");
				strBuff.append(sVal);
				break;
			...
			case GeneralName.rfc822Name:
				...
				strBuff.append(MsgResource.Res.getString("GeneralName." + tagNo));
				strBuff.append(": ");
			...
			default: // Unsupported general name type
				strBuff.append(MessageFormat.format(MsgResource.Res.getString("UnrecognizedGeneralNameType"),
	...
	private static String getRes(String key, String fallback)
	{
		try
		{
			return MsgResource.Res.getString(key);
		}
		catch (MissingResourceException e)
		{
			return MsgResource.Res.getString(fallback);
		}
	}
